    ...
    <form method="post" action="options.php"> 
       <?php settings_fields('wcw-group'); ?>
        <div class="wcw-setting">
			...
			<p><a href="https://www.wp-experts.in" target="_blank" class="contact-author">Contact Author</a></p>
				<p><a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=ZEMSYQUZRUK6A" target="_blank" style="font-size: 17px; font-weight: bold;"></a></p>
